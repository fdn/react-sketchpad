...
var SketchPad = function (_Component) {
  ...
  function SketchPad(props) {
    ...
    _this.useTouch = 'ontouchstart' in window;
    _this.onTouchStart = _this.onMouseDown.bind(_this);
    _this.onMouseDown = _this.onMouseDown.bind(_this);
    _this.onTouchMove = _this.onMouseMove.bind(_this);
    _this.onMouseMove = _this.onMouseMove.bind(_this);
    _this.onDebouncedMove = _this.onDebouncedMove.bind(_this);
    _this.onTouchEnd = _this.onMouseUp.bind(_this);
  ...
  _createClass(SketchPad, [{
    ...
    value: function getCursorPosition(e) {
      if (this.useTouch) {
        ...
        var _clientBounds = this.clientBounds,
            top = _clientBounds.top,
            left = _clientBounds.left;
        ...
        var _canvas$getBoundingCl = this.canvas.getBoundingClientRect(),
            _top = _canvas$getBoundingCl.top,
            _left = _canvas$getBoundingCl.left;

        return [e.clientX - _left, e.clientY - _top];
      }
    }
  }, {
    key: 'render',
